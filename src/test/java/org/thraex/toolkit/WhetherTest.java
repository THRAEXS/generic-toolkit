...
public class WhetherTest {
    ...
    public void test() {
        ...
        //
        //Assert.assertEquals(Integer.valueOf(1), Whether.YES.value());
        //Assert.assertEquals(Integer.valueOf(0), Whether.NO.value());
        //
    ...
    public void test1() {
        ...
        System.out.println(Whether.of(1));
        System.out.println(Whether.of(0));
        System.out.println(Whether.of(2));
    }
