...
import org.thraex.toolkit.exception.RequestMappingExceptionHandler;
...
@Documented
@Import({ TemporalFormatConfiguration.class, RequestMappingExceptionHandler.class, AuditorAwareConfiguration.class })
@Configuration
@Deprecated
